...
export const FLOW_TEMPLATES: FlowTemplate[] = [
  ...
  {
    id: 'llm-assistant',
    name: 'Assistant IA générative',
    description: 'Application utilisant un LLM externe pour générer du contenu ou répondre aux questions',
    ...
    nodes: [
      ...
      },
      {
        ...
        entityType: 'INFRA',
        label: 'Application',
        description: 'Interface et logique métier',
      ...
      },
      {
        ...
        description: 'Service d\'IA générative tiers (OpenAI, Anthropic, etc.)',
      ...
      },
      {
        ...
        description: 'Données métier et historique (RAG)',
      ...
      },
      {
        ...
        entityType: 'AI',
        label: 'Modération',
        description: 'Filtrage et vérification des sorties',
        dataTypes: ['INTERACTIONS'],
        position: { x: 720, y: 250 },
        inputCount: 2,
        outputCount: 1,
      },
      {
        ...
        entityType: 'INFRA',
        label: 'Réponse',
        description: 'Affichage de la réponse à l\'utilisateur',
        dataTypes: ['INTERACTIONS'],
        position: { x: 940, y: 250 },
        inputCount: 1,
      },
  ...
  },
  {
    ...
    description: 'Système IoT pour anticiper les pannes et optimiser la maintenance industrielle',
    category: 'Industrie',
    icon: '🏭',
    vigilanceLevel: 3,
    ...
    nodes: [
      {
        ...
        entityType: 'INFRA',
        label: 'Capteurs IoT',
        description: 'Capteurs sur les équipements industriels',
      ...
      },
      {
        ...
        description: 'Prétraitement local des données',
      ...
      },
      {
        ...
        type: 'DECISION',
        entityType: 'AI',
        label: 'Modèle prédictif cloud',
        description: 'Analyse ML pour prédiction de pannes',
        dataTypes: ['PREDICTION', 'SCORE'],
        position: { x: 480, y: 250 },
        inputCount: 1,
        outputCount: 2,
      },
      {
        ...
        description: 'Notification aux équipes terrain',
        dataTypes: ['PREDICTION'],
      ...
      },
      {
        ...
        entityType: 'ORG',
        label: 'Intervention',
        description: 'Opération de maintenance planifiée',
        dataTypes: ['DECISION'],
