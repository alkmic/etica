...
export const ACTION_TEMPLATES: Record<string, ActionTemplate> = {
  ...
  // =============================================================================
  // CERCLE 2 : ORGANISATION (Maîtrise, Responsabilité, Souveraineté)
  // =============================================================================

  TECHNICAL_DOCUMENTATION: {
    id: 'TECHNICAL_DOCUMENTATION',
    title: 'Documenter techniquement le système',
    ...
    checklist: [
      ...
      'Expliquer les choix algorithmiques',
      'Maintenir la documentation à jour',
      'Rendre accessible aux équipes concernées',
    ],
  },
  COMPETENCY_PLAN: {
    id: 'COMPETENCY_PLAN',
    ...
    checklist: [
      ...
      'Documenter les expertises clés',
    ],
  },
  VENDOR_ASSESSMENT: {
    id: 'VENDOR_ASSESSMENT',
    title: 'Évaluer la dépendance fournisseur',
    ...
    checklist: [
      ...
      'Négocier les clauses de réversibilité',
      'Planifier une stratégie de sortie',
    ],
  },
  DATA_LOCALIZATION: {
    id: 'DATA_LOCALIZATION',
    title: 'Localiser les données',
    description: 'S\'assurer que les données restent dans la juridiction souhaitée.',
    category: 'TECHNICAL',
    effort: 'LARGE',
    impactDomains: ['SOVEREIGNTY', 'PRIVACY'],
    checklist: [
      'Cartographier les flux de données',
      'Identifier les transferts hors zone',
      'Choisir des hébergements conformes',
  ...
  ESCALATION_CHAIN: {
    id: 'ESCALATION_CHAIN',
    title: 'Définir la chaîne d\'escalade',
    description: 'Établir clairement qui est responsable en cas de problème.',
    category: 'ORGANIZATIONAL',
    effort: 'SMALL',
    impactDomains: ['RESPONSIBILITY', 'RECOURSE'],
    checklist: [
      'Identifier les niveaux de décision',
      'Nommer les responsables par niveau',
      'Définir les critères d\'escalade',
      'Communiquer la chaîne aux équipes',
  ...
  EXECUTIVE_COMMITMENT: {
    ...
    description: 'Obtenir et formaliser l\'engagement de la direction sur l\'éthique IA.',
    category: 'ORGANIZATIONAL',
    effort: 'SMALL',
    impactDomains: ['RESPONSIBILITY', 'CONTROL'],
    checklist: [
      'Présenter les enjeux éthiques à la direction',
      'Formaliser l\'engagement par écrit',
      'Allouer des ressources dédiées',
      'Définir les indicateurs de suivi',
      'Communiquer l\'engagement en interne',
    ],
  },

  // =============================================================================
  // CERCLE 3 : SOCIÉTÉ (Durabilité, Loyauté, Équilibre sociétal)
  // =============================================================================

  CARBON_FOOTPRINT: {
    id: 'CARBON_FOOTPRINT',
    title: 'Mesurer l\'empreinte carbone',
    description: 'Évaluer et suivre l\'impact environnemental du système IA.',
    category: 'AUDIT',
    effort: 'MEDIUM',
    impactDomains: ['SUSTAINABILITY'],
    checklist: [
  ...
  GREEN_AI: {
    id: 'GREEN_AI',
    title: 'Optimiser pour la sobriété',
    ...
    checklist: [
      ...
      'Réduire la fréquence de réentraînement',
      'Mettre en cache les résultats fréquents',
      'Choisir une infrastructure éco-responsable',
    ],
  },
  STAKEHOLDER_COMMUNICATION: {
    id: 'STAKEHOLDER_COMMUNICATION',
    title: 'Communiquer avec les parties prenantes',
    description: 'Informer proactivement les partenaires et utilisateurs des évolutions.',
    category: 'TRANSPARENCY',
    effort: 'SMALL',
    impactDomains: ['LOYALTY', 'TRANSPARENCY'],
    checklist: [
      'Identifier les parties prenantes',
      'Définir les canaux de communication',
      'Planifier les communications régulières',
      'Prévenir en amont des changements',
      'Recueillir les retours',
    ],
  },
  FAIR_VALUE_SHARING: {
    id: 'FAIR_VALUE_SHARING',
    title: 'Partage équitable de la valeur',
    description: 'S\'assurer que la valeur créée est partagée équitablement.',
    category: 'ORGANIZATIONAL',
    effort: 'MEDIUM',
    impactDomains: ['LOYALTY', 'EQUITY'],
    checklist: [
      'Évaluer la valeur créée par le système',
      'Identifier les contributeurs (données, travail)',
      'Définir un modèle de partage',
      'Communiquer sur la répartition',
      'Réviser périodiquement',
    ],
  },
  SYSTEMIC_IMPACT_ASSESSMENT: {
    id: 'SYSTEMIC_IMPACT_ASSESSMENT',
    title: 'Évaluer l\'impact systémique',
    ...
    checklist: [
      ...
      'Analyser les effets sur l\'emploi',
      'Considérer les précédents créés',
      'Consulter des experts externes',
    ],
  },
  EMPLOYMENT_TRANSITION: {
    id: 'EMPLOYMENT_TRANSITION',
    title: 'Plan de transition emploi',
    ...
    checklist: [
      ...
      'Créer de nouveaux rôles de supervision',
      'Accompagner la transition',
    ],
  },
  SECTOR_COORDINATION: {
    id: 'SECTOR_COORDINATION',
    title: 'Coordination sectorielle',
    ...
    checklist: [
      ...
      'Contribuer aux standards',
      'Adopter les normes émergentes',
    ],
  },
} as const
